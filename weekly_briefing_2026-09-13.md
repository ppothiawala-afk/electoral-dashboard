...
- **MO-02 (Wagner, R — suburban St. Louis)** — **Solid R → Likely R.** The map reversion made this St. Louis suburban seat more competitive; [Cook, Sep 11](https://www.cookpolitical.com/analysis/house/missouri-house/two-missouri-house-race-ratings-change-after-redistricting-roller) and [Sabato, Sep 10](https://centerforpolitics.org/crystalball/rating-the-new-missouri-house-map/) both moved it to Likely R — a Cook+Sabato consensus. (Cook's exact tier was ambiguous across Cook's own material at run time and was queued as decisions.json `2026-09-13-mo-02-cook-tier`; **resolved by P-funk** confirming Cook at Likely R, so the cell moves.) ✅ Applied.
...
| House | MO-02 (Wagner, R) | Solid R | **Likely R** | [Cook Sep 11](https://www.cookpolitical.com/analysis/house/missouri-house/two-missouri-house-race-ratings-change-after-redistricting-roller) + [Sabato Sep 10](https://centerforpolitics.org/crystalball/rating-the-new-missouri-house-map/) (consensus; decision resolved) |
...
- ⚠️ **MO-02 (Cook tier) — initially CONTRADICTED / UNVERIFIABLE** (Cook's slug vs roundup disagreed, Lean R vs Likely R). **Resolved by P-funk**: Cook confirmed at Likely R, matching Sabato → Cook+Sabato consensus, so MO-02 moves **Solid R → Likely R** (applied to the patch and history). (decisions.json `2026-09-13-mo-02-cook-tier`: resolved.)
